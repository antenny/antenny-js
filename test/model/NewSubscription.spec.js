...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new antenny.NewSubscription();
  });
  ...
  describe('NewSubscription', function() {
    it('should create an instance of NewSubscription', function() {
      // uncomment below and update the code to test NewSubscription
      //var instane = new antenny.NewSubscription();
      //expect(instance).to.be.a(antenny.NewSubscription);
    });
